    ...
    for (var i=0; i<inputs.length; i++) {
        if (inputs[i].type.toLowerCase() === "password") {
            ...
            inputs[i].addEventListener('input' , (e)=> {
                ...
                e.target.nextElementSibling.addEventListener('click' , (el)=>{
                    console.log(e)
                })
            })
        }
            ...
            for (let i = 0; i < event.target.files.length; i++) {
                ...
                if (imgExt.indexOf(ext) > 0) {
                    ...
                    reader.onload = function (e) {
                        src = e.target.result;
                        selectedFilesCont.innerHTML += 
                        '<div class="img-uploaded uploaded-image mt-2 mb-2 position-relative">' +
                    ...
                    var name = event.target.files[i].name;
                    selectedFilesCont.innerHTML +=
                     '<div   class="file-container round m-1 ">' +
...
// show password
// let password_inputs = document.getElementsByTagName('input');

// console.log( password_inputs )

// password_inputs.array.forEach(el => {
